...
def healthy_msg(score1,score2):
                ...
                score2= score2.round()
                if score1 > 50.00:
                    st.write(f' {score1}% HEALTHY')
                    st.sidebar.write("Accuracy Metric: Above 50%")
                    st.sidebar.success(f'Accuracy: {score1}% HEALTHY')
                    
                else:
                    pass
                #if score2 > 50.00:
                 #   st.write(f'Cocoa is {score2}% HEALTHY')
                #else:
               #     pass 
...
def infected_msg(score1,score2):
    ...
    score2= score2.round()
    if score1 > 50.00:
        st.write(f'Accuracy:  {score1}% INFECTED')
        st.sidebar.write("Accuracy Metric: Above 50%")
        st.sidebar.error (f'Accuracy:  {score1}% INFECTED')
    else:
        pass
    #if score2 > 50.00:
